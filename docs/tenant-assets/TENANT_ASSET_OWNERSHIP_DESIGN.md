...
| 6.19+ | Status evidence collection/backfill/access-switch design gates | Only after review status evidence, owner-map proof, legal/product approval, and explicit operator approval. |
