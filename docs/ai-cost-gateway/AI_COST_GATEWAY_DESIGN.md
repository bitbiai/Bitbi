...
- Admin compare/live-agent, sync video debug, unmetered admin image, platform/background AI outside News Pulse visuals, and broader internal routes remain tracked baseline gaps.
...
- runtime env kill-switch enforcement, live platform budget caps, credit debits, Stripe calls, Admin compare/live-agent migration, and production/live billing readiness remain future work.
...
- cleanup does not delete rows or R2 objects, call providers, call Stripe,
  ...
  embeddings/music, migrate Admin compare/live-agent, or prove production/live
  billing readiness.
