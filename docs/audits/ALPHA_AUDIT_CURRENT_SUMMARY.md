...
Use `docs/tenant-assets/evidence/MAIN_FOLDERS_IMAGES_OWNER_MAP_DECISION.md` as the current Phase 6.10 decision and `docs/tenant-assets/AI_FOLDERS_IMAGES_MANUAL_REVIEW_WORKFLOW.md` for the Phase 6.11 review design. The next tenant-asset step should be Phase 6.12 manual review state schema design, with no broad backfill or access behavior change.
