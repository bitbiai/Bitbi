...
| `docs/tenant-assets/*.md` | Tenant asset ownership design, inventory, risk matrix, dry-run reports, Phase 6.3 schema/access plan, Phase 6.4 schema foundation notes, Phase 6.5 new-write metadata assignment notes, Phase 6.6 read diagnostics notes, and Phase 6.7 admin evidence report/export notes. |
