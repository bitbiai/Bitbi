...
Current release truth: `config/release-compat.json` declares the latest auth D1 migration as `0052_add_admin_runtime_budget_switches.sql`. Phase 4.15.1 adds the D1-backed Admin AI Budget Switch Control Plane on top of the Phase 4.15 Cloudflare master switches while preserving completed Phase 4.16 live platform budget cap design/evidence.
