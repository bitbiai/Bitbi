...
| `docs/tenant-assets/*.md`, `docs/tenant-assets/evidence/*.md` | Tenant asset ownership design, inventory, risk matrix, dry-run reports, Phase 6.3 schema/access plan, Phase 6.4 schema foundation notes, Phase 6.5 new-write metadata assignment notes, Phase 6.6 read diagnostics notes, Phase 6.7 admin evidence report/export notes, Phase 6.8 evidence collection runbook/template/checklist, Phase 6.9 main-only evidence package records, Phase 6.10 real main evidence decision/manual-review status, Phase 6.11 manual-review workflow/plan records, Phase 6.12 manual-review state schema design records, Phase 6.13 additive review-state schema notes, Phase 6.14 review import dry-run planning notes, Phase 6.15 review-item import executor notes, Phase 6.16 read-only queue/evidence API notes, Phase 6.17 review-status workflow notes, Phase 6.18 operator evidence/Admin visibility notes, Phase 6.19 manual-review status operator evidence collection notes, Phase 6.20 operator evidence decision update records, Phase 6.21 legacy media reset dry-run notes, and Phase 6.22 reset executor design notes. |
