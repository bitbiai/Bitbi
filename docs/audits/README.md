...
| `docs/tenant-assets/*.md`, `docs/tenant-assets/evidence/*.md` | Tenant asset ownership design, inventory, risk matrix, dry-run reports, manual-review workflow/schema/import/queue/status/evidence records, Phase 6.20 operator evidence decision records, Phase 6.21 legacy media reset dry-run notes, Phase 6.22 reset executor design notes, and Phase 6.23 reset action tracking/executor notes. |
