...
prompts, lyrics, audio, or provider bodies. These phases do not call real
providers in tests, change public billing, add Admin UI, migrate Admin
compare/live-agent, migrate Admin video beyond Phase 4.5, migrate OpenClaw/News
...
Phase 4.6, Phase 4.7, Phase 4.8, Phase 4.8.1, Phase 4.8.2, and Phase 4.9
metadata/inspection responses must not include raw prompts, raw lyrics, raw
audio, raw provider request bodies, auth headers, cookies, Stripe data,
