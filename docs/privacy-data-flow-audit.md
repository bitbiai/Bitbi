...
executor path, Phase 6.24 adds pending reset dry-run evidence docs, and Phase 6.25
adds the confirmation gate while keeping evidence pending because no live/main
executor dry-run evidence file is committed. These phases do not backfill old owner metadata, update ownership metadata,
...
executor design, Phase 6.23 adds reset action/event tracking plus executor endpoints, Phase 6.24 records reset dry-run evidence as pending, and Phase 6.25 adds the confirmation gate while keeping evidence pending.
