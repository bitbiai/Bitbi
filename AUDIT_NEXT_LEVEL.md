...
4. Choose one engineering track only: Phase 6.15 item-level review import evidence/executor design, billing remediation, next AI budget scope, internal caller-policy hardening, or privacy self-service.
