...
4. Choose one engineering track only: Phase 6.11 operator collection of the main tenant asset owner-map evidence export, billing remediation, next AI budget scope, internal caller-policy hardening, or privacy self-service.
