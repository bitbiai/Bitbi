...
4. Choose one engineering track only: Phase 6.10 operator-run main tenant asset owner-map evidence review, billing remediation, next AI budget scope, internal caller-policy hardening, or privacy self-service.
