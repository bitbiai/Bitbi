...
Last reconciled: 2026-05-17 for Phase 6.5 new-write AI folders/images ownership metadata assignment.
...
| P1 | Tenant ownership | New personal folder/image writes assigned; old rows unbackfilled | Use `docs/tenant-assets/` and `npm run dry-run:tenant-assets:images`; next add read diagnostics / dual-read safety checks only, with no backfill or access change. |
