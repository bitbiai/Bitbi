...
test.describe('Bilingual locale pages', () => {
  ...
  test('member workspace navigation keeps English and German routes equivalent', () => {
    ...
    expect(enAssets).toContain('assets-manager__storage-panel');
    expect(enAssets).toContain('Storage status');
    expect(enAssets).toContain('Storage details appear after your library loads');
    ...
    expect(deAssets).toContain('assets-manager__storage-panel');
    expect(deAssets).toContain('Speicherstatus');
    expect(deAssets).toContain('Speicherdetails erscheinen, sobald Ihre Bibliothek geladen ist.');
    ...
    expect(enGenerate).toContain('href="/account/profile.html?returnContext=generate-lab#profileCompletionCard"');
    ...
    expect(deGenerate).toContain('href="/de/account/profile.html?returnContext=generate-lab#profileCompletionCard"');
