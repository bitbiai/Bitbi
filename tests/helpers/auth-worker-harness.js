...
function defaultPlatformBudgetLimitRows() {
  return [
    ...
    },
    {
      ...
      starts_at: null,
      ends_at: null,
      reason: 'test harness default OpenClaw News Pulse daily cap',
      metadata_json: '{"source":"test_harness"}',
      created_at: '2026-05-16T00:00:00.000Z',
      updated_at: '2026-05-16T00:00:00.000Z',
      created_by_user_id: 'test-harness',
    ...
    },
    {
      ...
      starts_at: null,
      ends_at: null,
      reason: 'test harness default OpenClaw News Pulse monthly cap',
      metadata_json: '{"source":"test_harness"}',
      created_at: '2026-05-16T00:00:00.000Z',
      updated_at: '2026-05-16T00:00:00.000Z',
      created_by_user_id: 'test-harness',
...
function createAuthTestEnv(seed = {}) {
  ...
  return {
    ...
    ENABLE_ADMIN_AI_XAI_IMAGE_BUDGET: budgetFlag('ENABLE_ADMIN_AI_XAI_IMAGE_BUDGET'),
    ...
    MEMVID_STREAM_PREVIEW_DISPATCH_PROVIDER: seed.MEMVID_STREAM_PREVIEW_DISPATCH_PROVIDER,
    GITHUB_ACTIONS_DISPATCH_TOKEN: seed.GITHUB_ACTIONS_DISPATCH_TOKEN,
    GITHUB_ACTIONS_DISPATCH_OWNER: seed.GITHUB_ACTIONS_DISPATCH_OWNER,
    GITHUB_ACTIONS_DISPATCH_REPO: seed.GITHUB_ACTIONS_DISPATCH_REPO,
    GITHUB_ACTIONS_DISPATCH_WORKFLOW: seed.GITHUB_ACTIONS_DISPATCH_WORKFLOW,
    GITHUB_ACTIONS_DISPATCH_REF: seed.GITHUB_ACTIONS_DISPATCH_REF,
    ...
    STRIPE_LIVE_CUSTOMER_PORTAL_RETURN_URL: seed.STRIPE_LIVE_CUSTOMER_PORTAL_RETURN_URL,
    ENABLE_STRIPE_AUTOMATIC_TAX: seed.ENABLE_STRIPE_AUTOMATIC_TAX,
    ENABLE_STRIPE_TAX_ID_COLLECTION: seed.ENABLE_STRIPE_TAX_ID_COLLECTION,
    ENABLE_STRIPE_INVOICE_CREATION: seed.ENABLE_STRIPE_INVOICE_CREATION,
