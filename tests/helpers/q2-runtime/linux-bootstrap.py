...
REPORT_NAMES = {"isolation-result.json", "isolation-final.json", "linux-child-probe.json", "linux-child-probe-final.json", "result.json",
                "native-result.json", "references-result.json", "recovery-result.json", "model-status-result.json", "canvas-result.json",
...
def main():
    ...
    parser.add_argument("--suite", choices=["member-generation", "model-status", "canvas"])
