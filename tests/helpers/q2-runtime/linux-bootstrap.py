...
REPORT_NAMES = {"isolation-result.json", "isolation-final.json", "linux-child-probe.json", "linux-child-probe-final.json", "result.json",
                "native-result.json", "references-result.json", "recovery-result.json", "model-status-result.json", "canvas-result.json", "q4-stream-result.json", "member-generation-result.json",
...
def main():
    ...
    parser.add_argument("--suite", choices=["member-generation", "model-status", "canvas", "q4-stream"])
