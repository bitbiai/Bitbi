...
- Organization, membership, billing, entitlement, credit ledger, usage-event, and AI usage-attempt export/delete behavior is not yet integrated into lifecycle plans; Phase 2-A/2-B/2-C/2-D/2-E/2-F/2-H only add schema, helpers, minimal APIs, org-scoped image/text generation debits, retry-safe attempt tracking, bounded attempt cleanup/inspection, and bounded temporary replay cleanup.
