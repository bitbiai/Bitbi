...
- Organization, membership, billing, entitlement, credit ledger, usage-event, and AI usage-attempt export/delete behavior is not yet integrated into lifecycle plans; Phase 2-A/2-B/2-C/2-D/2-E only add schema, helpers, minimal APIs, opt-in org-scoped image generation debits, retry-safe attempt tracking, and bounded attempt cleanup/inspection.
...
- Whether temporary AI usage replay objects need explicit storage cleanup beyond Phase 2-E replay-metadata expiry.
