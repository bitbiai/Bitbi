...
export const ADMIN_PLATFORM_BUDGET_SWITCH_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    switchKey: "ENABLE_ADMIN_AI_XAI_IMAGE_BUDGET",
    flagName: "ENABLE_ADMIN_AI_XAI_IMAGE_BUDGET",
    label: "Admin xAI Image Budget",
    description: "Allows charged Admin Image tests for xAI priced models when selected-organization credits also pass.",
    category: "admin_image",
    budgetScope: "admin_org_credit_account",
    operationIds: Object.freeze(["admin.image.test.charged"]),
    ownerDomain: "admin-ai-image",
    ...
    riskLevel: "high",
    requiresMasterFlag: true,
    recommendedOperatorNote: "Enable only for bounded charged Admin xAI Image testing with selected organization context.",
    relatedRoutes: Object.freeze(["POST /api/admin/ai/test-image"]),
    liveCapStatus: "not_implemented",
    liveCapFuturePhase: "Future admin_org_credit_account cap integration after Phase 4.17 foundation",
  }),
  ...
  Object.freeze({
    ...
    description: "Allows Admin Text tests and the private Fable chat through the shared platform text budget controls.",
    category: "admin_lab",
    budgetScope: "platform_admin_lab_budget",
    operationIds: Object.freeze(["admin.text.test", "admin.fable_chat.send"]),
    ...
    relatedRoutes: Object.freeze([
      "POST /api/admin/ai/test-text",
      "POST /api/admin/fable-chat/conversations/:id/messages",
    ]),
    liveCapStatus: "cap_enforced",
    liveCapFuturePhase: "Phase 4.17 platform_admin_lab_budget cap foundation",
  }),
