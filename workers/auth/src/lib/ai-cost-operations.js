...
export const AI_COST_OPERATION_REGISTRY = Object.freeze([
  ...
  operation({
    operationConfig: {
      ...
      notes: "Provider task creation is invoked by the auth worker queue consumer only after admin video job budget metadata is verified.",
    },
    ...
    routePolicy: null,
    currentGaps: ["Internal AI Worker route does not enforce budget globally; Phase 4.5 enforcement is caller/job scoped from the auth queue."],
    gapSeverity: "P3",
  ...
  operation({
    operationConfig: {
      ...
      notes: "Provider task polling uses an existing providerTaskId and verified admin video job budget metadata; it does not create a new generation task.",
    },
    sourceFiles: ["workers/auth/src/lib/ai-video-jobs.js", "workers/ai/src/routes/video-task.js", "workers/ai/src/lib/invoke-ai-video.js"],
    currentStatus: "implemented",
    currentEnforcement: {
