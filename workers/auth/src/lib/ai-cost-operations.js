...
const BUDGET_POLICY_BY_OPERATION_ID = Object.freeze({
  "admin.text.test": budgetPolicy(AI_COST_BUDGET_SCOPES.PLATFORM_ADMIN_LAB_BUDGET, {
    ...
    targetEnforcement: { idempotency: "durable_metadata_only", budgetLedger: "platform_admin_lab_budget_metadata", replay: "metadata_only_no_result_replay", killSwitch: "ENABLE_ADMIN_AI_TEXT_BUDGET runtime_enforced", runtimeKillSwitch: "implemented" },
  ...
  "admin.embeddings.test": budgetPolicy(AI_COST_BUDGET_SCOPES.PLATFORM_ADMIN_LAB_BUDGET, {
    ...
    targetFuturePhase: "Phase 4.15 runtime budget kill-switch enforcement",
    targetEnforcementStatus: "partial",
    targetEnforcement: { idempotency: "durable_metadata_only", budgetLedger: "platform_admin_lab_budget_metadata", replay: "metadata_only_no_vectors", killSwitch: "ENABLE_ADMIN_AI_EMBEDDINGS_BUDGET runtime_enforced", runtimeKillSwitch: "implemented" },
  ...
  "admin.music.test": budgetPolicy(AI_COST_BUDGET_SCOPES.PLATFORM_ADMIN_LAB_BUDGET, {
    ...
    targetFuturePhase: "Phase 4.15 runtime budget kill-switch enforcement",
    targetEnforcementStatus: "partial",
    targetEnforcement: { idempotency: "durable_metadata_only", budgetLedger: "platform_admin_lab_budget_metadata", replay: "metadata_only_no_audio", killSwitch: "ENABLE_ADMIN_AI_MUSIC_BUDGET runtime_enforced", runtimeKillSwitch: "implemented" },
  ...
  "admin.compare": budgetPolicy(AI_COST_BUDGET_SCOPES.PLATFORM_ADMIN_LAB_BUDGET, {
    ...
    targetFuturePhase: "Phase 4.15 runtime budget kill-switch enforcement",
    targetEnforcementStatus: "partial",
    targetEnforcement: { idempotency: "durable_metadata_only", budgetLedger: "platform_admin_lab_budget_metadata", replay: "metadata_only_no_compare_results", killSwitch: "ENABLE_ADMIN_AI_COMPARE_BUDGET runtime_enforced", runtimeKillSwitch: "implemented" },
