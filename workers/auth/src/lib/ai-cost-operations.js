...
const BUDGET_POLICY_BY_OPERATION_ID = Object.freeze({
  ...
  "platform.news_pulse.visual.ingest": budgetPolicy(AI_COST_BUDGET_SCOPES.OPENCLAW_NEWS_PULSE_BUDGET, {
    ...
    targetEnforcementStatus: "implemented",
    targetEnforcement: { idempotency: "deterministic_item_key", budgetLedger: "openclaw_news_pulse_budget_metadata", replay: "durable_thumbnail", killSwitch: "ENABLE_NEWS_PULSE_VISUAL_BUDGET runtime_enforced", runtimeKillSwitch: "implemented" },
...
export const AI_COST_OPERATION_REGISTRY = Object.freeze([
  ...
  operation({
    operationConfig: {
      ...
      notes: "OpenClaw ingest can schedule provider-cost News Pulse visual generation; Phase 4.15 enforces ENABLE_NEWS_PULSE_VISUAL_BUDGET before provider execution.",
    },
  ...
  operation({
    operationConfig: {
      ...
      notes: "Scheduled News Pulse visual backfill can call the image provider for missing/failed thumbnails; Phase 4.15 enforces ENABLE_NEWS_PULSE_VISUAL_BUDGET before provider execution.",
    },
