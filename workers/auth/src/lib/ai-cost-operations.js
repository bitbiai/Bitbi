...
export const AI_COST_OPERATION_REGISTRY = Object.freeze([
  ...
  operation({
    operationConfig: {
      ...
      notes: "Internal sync video route remains service-only and baseline-compatible; Phase 4.13 retires the Auth Worker sync debug caller as disabled-by-default while keeping async video task routes caller-enforced.",
    },
