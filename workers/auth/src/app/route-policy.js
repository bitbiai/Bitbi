...
export const ROUTE_POLICIES = Object.freeze([
  ...
  adminJsonWrite("admin.ai.test-text", "POST", "/api/admin/ai/test-text", "admin-ai", "adminJson", "admin-ai-text-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_TEXT_BUDGET before durable metadata-only idempotency attempts or provider proxying. Live platform budget caps remain future work.",
  ...
  adminJsonWrite("admin.ai.test-image", "POST", "/api/admin/ai/test-image", "admin-ai", "adminJson", "admin-ai-image-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires the charged model-specific budget switch before provider calls or credit debits, and requires ENABLE_ADMIN_AI_UNMETERED_IMAGE_TESTS before FLUX.2 Dev provider execution. Live platform budget caps remain future work.",
    },
  ...
  adminJsonWrite("admin.ai.test-embeddings", "POST", "/api/admin/ai/test-embeddings", "admin-ai", "adminJson", "admin-ai-embeddings-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_EMBEDDINGS_BUDGET before durable metadata-only idempotency attempts or provider proxying. Live platform budget caps remain future work.",
  ...
  adminJsonWrite("admin.ai.test-music", "POST", "/api/admin/ai/test-music", "admin-ai", "adminJson", "admin-ai-music-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_MUSIC_BUDGET before durable metadata-only idempotency attempts or provider proxying. Live platform budget caps remain future work.",
  ...
  adminJsonWrite("admin.ai.video-jobs.create", "POST", "/api/admin/ai/video-jobs", "admin-ai", "adminVideoJobJson", "admin-ai-video-job-create-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_VIDEO_JOB_BUDGET before job rows are created or provider-cost queue work is enqueued. Queue processing still verifies job budget metadata before internal video-task create/poll calls. Live platform budget caps remain future work.",
    },
  ...
  adminJsonWrite("admin.ai.compare", "POST", "/api/admin/ai/compare", "admin-ai", "adminJson", "admin-ai-compare-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_COMPARE_BUDGET before durable metadata-only idempotency attempts or proxying to the multi-model compare route. Live platform budget caps remain future work.",
  ...
  adminJsonWrite("admin.ai.live-agent", "POST", "/api/admin/ai/live-agent", "admin-ai", "adminJson", "admin-ai-liveagent-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Phase 4.15 requires ENABLE_ADMIN_AI_LIVE_AGENT_BUDGET before durable metadata-only stream-session attempts or proxying to the streaming live-agent route. Explicit output-token caps, stream-duration caps, and live platform budget caps remain future work.",
