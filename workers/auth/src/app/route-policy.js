...
export const ROUTE_POLICIES = Object.freeze([
  ...
  adminJsonWrite("admin.ai.test-text", "POST", "/api/admin/ai/test-text", "admin-ai", "adminJson", "admin-ai-text-ip", {
    ...
    billing: {
      ...
      runtimeEnforcement: "Builds a platform_admin_lab_budget plan and durable metadata-only idempotency attempt before proxying. Runtime env kill-switch enforcement and live platform budget caps remain future work. Admin compare/live-agent remain separate unmigrated gaps.",
