...
- `0050_add_news_pulse_visual_budget_metadata` — required before Phase 4.6 News Pulse visual generation/backfill can store sanitized `openclaw_news_pulse_budget` metadata, future kill-switch target metadata, budget fingerprints, and safe visual budget runtime status
