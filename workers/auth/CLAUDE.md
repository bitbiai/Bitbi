...
Migrations in `migrations/` are numbered sequentially from `0001_init` through `0047_add_member_subscriptions_and_credit_buckets`. Current release metadata declares latest auth D1 migration `0047_add_member_subscriptions_and_credit_buckets.sql`.
