  ...
  try {
    ...
    return ok({
      ...
      result: {
        ...
        referenceImageCount: output.referenceImageCount ?? input.referenceImages?.length ?? 0,
        quality: output.appliedQuality || null,
        size: input.size || null,
        outputFormat: output.appliedOutputFormat || null,
        aspectRatio: output.appliedAspectRatio || null,
        resolution: output.appliedResolution || null,
        responseFormat: output.appliedResponseFormat || null,
        outputCount: output.appliedOutputCount ?? null,
        inputImageCount: output.inputImageCount ?? null,
        hasPrimaryImage: output.hasPrimaryImage ?? null,
        hasMask: output.hasMask ?? null,
