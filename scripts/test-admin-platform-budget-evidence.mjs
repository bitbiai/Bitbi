...
assert.equal(report.summary.adminPlatformImplemented, 11);
...
assert(report.livePlatformBudgetCaps.capEnforcedOperationIds.includes("admin.fable_chat.compact_memory"));
...
assert(implementedIds.includes("admin.fable_chat.compact_memory"));
