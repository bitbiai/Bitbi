...
const SITE_ROOT_DIRS = ["assets", "css", "fonts", "js", "experiments", "account", "admin", "legal"];
const SOURCE_SCAN_ROOTS = ["index.html", "admin", "account", "experiments", "legal", "js", "CLAUDE.md"];
