...
export const SITE_ROOT_DIRS = ["assets", "css", "fonts", "js", "account", "admin", "legal", "generate-lab", "canvas", "de"];
const SOURCE_SCAN_ROOTS = ["index.html", "pricing.html", "admin", "account", "legal", "generate-lab", "canvas", "de", "js", "_worker.js", "CLAUDE.md"];
