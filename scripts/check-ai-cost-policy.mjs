...
export function renderAiCostPolicyReport(result) {
  ...
  return [
    ...
    "- Phase 4.8.1 admin text/embeddings and Phase 4.9 admin music use admin_ai_usage_attempts for durable metadata-only duplicate suppression and conflict detection; Phase 4.8.2 adds bounded non-destructive cleanup and admin-only sanitized inspection; full result replay/live budget caps remain future work.",
    "",
    "Known baseline gaps:",
    ...
    "- Phase 4.10 should target one remaining Admin AI gap such as compare, live-agent, sync video debug, the unmetered image branch, or an internal caller path without changing member/org billing behavior or broad platform/background AI.",
