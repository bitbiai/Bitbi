...
test('actual selected Worker shell stops before downstream work on every failure', t => {
  ...
  for(const [status,selected,canvas='false',pricing='false',appearance='false'] of [['false','true'],['false','false'],['true','false'],['false','false','true'],['false','false','false','true'],['false','false','false','false','true']]) {
    ...
    const passed=run();assert.equal(passed.status,0);assert.equal(passed.commands.length,appearance==='true'?3:pricing==='true'?4:canvas==='true'?11:status==='true'||selected==='true'?3:1);
