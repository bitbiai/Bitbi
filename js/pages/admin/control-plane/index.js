        ...
        const cards = [
            {
                ...
                actions: [
                    ...
                    { label: 'Download dry-run report', onClick: (button) => tenantAssetsDomain.exportLegacyMediaResetDryRunJson(button) },
                ],
            },
            {
                ...
                actions: [
                    ...
                    { label: 'Export manual-review evidence', onClick: (button) => tenantAssetsDomain.exportTenantAssetManualReviewEvidenceJson(button) },
                ],
            },
            {
