const SECTION_DOM_IDS = {
    ...
    users: 'sectionUsers',
    'ai-lab': 'sectionAiLab',
    newsfeed: 'sectionNewsfeed',
    'model-status': 'sectionModelStatus',
    'model-pricing': 'sectionModelPricing',
...
const SECTION_META = {
    ...
    'model-pricing': { title: 'Model Pricing', desc: 'Factory prices and effective credit tariffs' },
    appearance: { title: 'Appearance', desc: 'Shared appearance for each part of BITBI' },
    'model-status': { title: 'Model status', desc: 'Observed outcomes, execution paths and processing — without test generations.' },
    newsfeed: { title: 'Newsfeed', desc: 'Browse stored news and inspect their available imagery. Read-only.' },
